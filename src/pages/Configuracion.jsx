                        ...
                        <tr key={usr.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm">
                            <span className={`px-2.5 py-1 inline-flex text-xs leading-5 font-bold rounded-full ${
                              ...
                              {usr.rol} {usr.estado === false ? '(Inactivo)' : ''}
                            </span>
                          </td>
                            ...
                            {usr.id !== session.user.id && (
                              <>
                                <select
                                  ...
                                  className="border border-slate-300 dark:border-slate-600 rounded-lg px-2 py-1.5 bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-xs font-semibold outline-none"
                                >
                                  <option value="Pendiente">Pendiente (Bloqueado)</option>
                                  <option value="Orientador">Orientador (Acceso)</option>
                                  <option value="Lector">Lector</option>
                                  <option value="Administrador">Administrador</option>
                                </select>
                                <button
                                  onClick={() => handleOpenPermisos(usr)}
                                  className="inline-flex items-center px-2.5 py-1.5 border border-slate-300 dark:border-slate-600 rounded-lg text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                                >
